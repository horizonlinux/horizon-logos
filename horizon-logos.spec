...
Source: github.com/horizonlinux/horizon-logos
...
%description
The horizon-logos package contains image files which place horizon logo in different parts of the system.
...
%package classic
Summary:	Horizon-related icons and pictures for applications using classic versions of fedora logos
Provides:	system-logos-httpd = %{version}-%{release}
BuildArch:	noarch
Recommends:	julietaula-montserrat-fonts
Provides:	system-logos(httpd-logo-ng)
...
# General purpose Horizon logos
for i in pixmaps/* ; do
  install -p -m 644 $i $RPM_BUILD_ROOT%{_datadir}/pixmaps
done

# Anaconda release notes (that contain Horizon logos)
...
# The Plymoth spinner theme Horizon logo bits
...
# Horizon logos for the clearlooks theme (icewm)
...
%changelog
* Tue Jan 28 2025 Microwave <micro.mail88@gmail.com>
- horizon version of fedora-logos package created
